...
/**
 * Shared component for displaying analysis results (scores + suggestions)
 * Used by both dashboard/analyze/[id] and professor/analyses/[id]
 *
 * Props:
 *   analysis    - object from analyses table
 *   categories  - array of { key, label, max }
 *   backLink    - path for "back" button (e.g. '/dashboard/history')
 *   newLink     - path for "new analysis" button (e.g. '/dashboard/analyze')
 *   extraHeader - ReactNode (optional) e.g. professor sees student name
 */
