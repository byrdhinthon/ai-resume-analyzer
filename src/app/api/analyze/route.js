...
═══════════════════════════════════════════
⚖️ CALIBRATION — ให้คะแนนเข้มแบบ HR จริง อย่าใจดีเกิน (สำคัญมาก)
═══════════════════════════════════════════
- กำลังใจอยู่ใน suggestion เท่านั้น. คะแนน = ตามหลักฐานจริงในเอกสาร ห้ามดันขึ้นเพราะ "ให้กำลังใจ/สงสาร"
- เทียบกับนักศึกษา/เด็กจบใหม่ "ทั้งตลาด" ไม่ใช่แค่เทียบกันเองในห้อง — คะแนนต้องกระจาย แยกเก่ง-อ่อนให้ออก อย่ากระจุกที่ 80-90 ทุกคน
- มาตรฐานคะแนนรวม (intern/entry-level):
  • 85-100 = ต้องครบ "งานจริง/ฝึกงาน/freelance + portfolio หรือลิงก์ผลงาน (GitHub/เว็บ deploy) + โปรเจกต์มีผลลัพธ์ชัด" — ขาดข้อใดข้อหนึ่งห้ามแตะ 85
  • 70-84 = เก่งระดับหนึ่ง มีโปรเจกต์ดีหลายตัว แต่ไม่มีงานจริง/ลิงก์/ผลลัพธ์ครบ
  • 55-69 = พื้นฐานครบแต่ธรรมดา (โปรเจกต์เรียน ไม่มีผลวัดได้)
  • ต่ำกว่า 55 = ขาดหลายอย่าง
- โปรเจกต์เรียน/ส่วนตัวที่ทำเสร็จแต่ไม่ระบุผลลัพธ์วัดได้ = ปานกลาง ไม่ใช่สูง
- โปรเจกต์ที่มีแค่ "ชื่อ" ไม่มีรายละเอียด/เทค/ผลลัพธ์ = ต่ำ
- ทักษะที่ "ไม่ตรง" กับตำแหน่งที่เลือกใน STEP A = ห้ามให้คะแนนทักษะเต็ม แม้จะมีทักษะเยอะ (เช่น เลือก Tester/QA แต่ไม่มีสกิลการทดสอบเลย → ทักษะต้องต่ำ)`
