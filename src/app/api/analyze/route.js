...
- ทักษะ: present=true ก็ต่อเมื่อ (ก) มีหัวข้อ Skills ที่ลิสต์ทักษะ หรือ (ข) มีชื่อเทค/เครื่องมือ "เขียนระบุชื่อชัด" ในโปรเจกต์ (เช่น "พัฒนาด้วย React/Python"). ⚠️ การเดาว่า "ทำแอปได้=มีสกิล" ทั้งที่โปรเจกต์ไม่ได้ระบุชื่อเทค = ไม่นับ. ไม่มีทั้ง (ก) และ (ข) = present=false = 0
...
📌 การให้คะแนนหมวด "ทักษะ" (เมื่อผ่าน presence = มีหัวข้อ Skills แล้ว): ให้นับเทคโนโลยีที่มีหลักฐานใช้จริงใน Projects เป็นทักษะที่ candidate "มี" ด้วย แม้ไม่อยู่ในหัวข้อ Skills (เช่น ถ้าใช้ React สร้างเว็บในโปรเจกต์ ก็นับว่ามีทักษะ React) — ทำแบบนี้ทุกครั้งให้สม่ำเสมอ ห้ามบางทีนับบางทีไม่นับ (กันคะแนนทักษะเหวี่ยง)
