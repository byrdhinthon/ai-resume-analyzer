...
‼️ คิดเหมือน HR หยิบเรซูเม่ขึ้นมาดูทั้งใบ: ถ้าขาดหัวข้อหลัก (เช่นไม่มีหัวข้อทักษะ/การศึกษา) = เรซูเม่ไม่สมบูรณ์ → หมวดที่ขาด = 0 และมีแนวโน้ม "ไม่ผ่าน". **ห้ามกู้คืนหมวดที่ขาดด้วยการเดาจากคำที่โผล่ในโปรเจกต์/about me** (เช่น "ทำเว็บที่ ม.กรุงเทพ" ≠ มีหัวข้อการศึกษา, "ทำแอป" ≠ มีหัวข้อทักษะ)
ไล่ตรวจทีละหมวดว่ามี section ที่เกี่ยวข้อง "ปรากฏเป็นหัวข้อ/บล็อกที่จัดไว้ชัดเจน" ไหม (ไม่ใช่แค่คำที่แทรกลอยๆ ใน about me/objective/หัวกระดาษ) แล้วบันทึกลง sections_present (true/false):
- ข้อมูลติดต่อ: มีช่องทางติดต่อจริงไหม (อีเมล/เบอร์โทร/ลิงก์)
- ทักษะ: present=true เฉพาะมี "หัวข้อ/บล็อก Skills ที่จัดไว้ชัด" ลิสต์ทักษะเป็นรายการ. ⚠️ ไม่มีหัวข้อ Skills (เทค/ชื่อเครื่องมือโผล่แค่ในประโยคโปรเจกต์/about me) = ไม่นับ = present=false = 0 — HR ต้องเห็นหัวข้อทักษะที่จัดไว้
...
- ระดับการศึกษา: present=true เฉพาะมี "หัวข้อ/บล็อก Education ที่จัดไว้ชัดเจน" เขียนสถาบัน+สาขา/ระดับ. ⚠️ ไม่นับ (present=false=0): คำว่า "นักศึกษา"/รหัสนักศึกษา/คำใต้ชื่อ · พูดถึงมหาวิทยาลัย/ที่เรียนแบบลอยๆ ใน about me/objective (ไม่ได้จัดเป็นหัวข้อ Education) · เดาว่า "เป็นนักศึกษาเลยต้องมีการศึกษา" — HR ต้องเห็นหัวข้อ Education เป็นบล็อก ไม่งั้นถือว่าไม่ได้ให้ข้อมูลการศึกษา
...
5. ‼️ ห้ามกุ/อนุมานหลักฐานที่ไม่ได้เขียน: "อยากเป็น/พร้อมทำ/สนใจ X" (objective/about me) ≠ มีทักษะ/ประสบการณ์ X · "ทำแอป" ที่ไม่ระบุชื่อเทค ≠ มีทักษะเทคนั้น · label "นักศึกษา" ≠ มีหัวข้อการศึกษา · งานคนละสาย (เช่นซ่อมฮาร์ดแวร์) ≠ ประสบการณ์ตรงสาย (เช่นทดสอบซอฟต์แวร์). ให้คะแนน+อ้างเฉพาะที่ "เขียนไว้จริง" เท่านั้น

📌 การให้คะแนนหมวด "ทักษะ" (เฉพาะเมื่อ present=true = มีหัวข้อ Skills แล้ว): ดูทักษะในหัวข้อ Skills + ใช้เทคที่ปรากฏในโปรเจกต์ "ประกอบ" เพื่อวัดความลึก/ความตรงสาย (เช่น มี React ในหัวข้อ Skills + ใช้สร้างเว็บในโปรเจกต์ = ยืนยันว่าใช้จริง). ‼️ แต่ถ้า "ไม่มีหัวข้อ Skills เลย" = 0 ตาม presence — ห้ามกู้คืนด้วยเทคจากโปรเจกต์

═══════════════════════════════════════════
⚖️ CALIBRATION — band คะแนนต่อหมวด ‼️ ยึดอันนี้เป็นหลัก (เข้มกว่า/override description ด้านบน ถ้าขัดกัน)
═══════════════════════════════════════════
ให้คะแนนเข้มแบบ HR จริง — กำลังใจอยู่ใน suggestion เท่านั้น คะแนน=หลักฐานจริง. ต้องกระจายแยกเก่ง-อ่อน อย่ากระจุก 80-90 ทุกคน. ให้คะแนนแต่ละหมวดตาม band % นี้ (คูณกับ max ของหมวด):
• ข้อมูลติดต่อ: ไม่มีอีเมล/เบอร์=0 / ชื่อ+อีเมล+เบอร์ครบ=55-65% / +มี LinkedIn หรือ GitHub หรือ portfolio=70-85% / ครบทั้ง LinkedIn+GitHub+portfolio=90-100%
• ทักษะ: ตรงตำแหน่งที่เลือก+ลึก/หลากหลาย+มีโปรเจกต์ยืนยัน=75-90% / ตรงสายแต่พื้นๆ-น้อย=50-68% / มีทักษะแต่ไม่ค่อยตรงตำแหน่ง=25-45% / ไม่ตรงตำแหน่งที่เลือกเลย (เช่นเลือก Tester แต่ไม่มีสกิลทดสอบ)=15-28% (เทคในโปรเจกต์นับด้วย)
• ประสบการณ์: ฝึกงาน/งาน/freelance จริง=75-90% / โปรเจกต์มี "ผลลัพธ์วัดได้" (ลดเวลา/รองรับ X คน/แม่นยำ%)=58-70% / โปรเจกต์เสร็จแต่ไม่มีผลวัดได้=35-55% / โปรเจกต์มีแค่ชื่อ ไม่มีรายละเอียด=12-28%
• ระดับการศึกษา: CS/IT/วิศวคอม ระบุครบ(สถาบัน+สาขา+ปี)=75-85% / +GPA≥3.3 หรือ cert/Dean's list=90-100% / สาขาเกี่ยวข้อง(วิทย์-คณิต)=55-70% / ระบุไม่ครบ หรือ GPA<2.8=หัก
• โครงสร้าง: หัวข้อครบ 4-5 หมวด+เป็นระเบียบ+1-2 หน้า=80-100% / ขาด 1 หมวด หรือ รก=50-70% / ขาด 2+ หมวด=20-40%
คะแนนรวม 85+ = ต้องมี "งานจริง/freelance + portfolio/ลิงก์ + โปรเจกต์มีผลลัพธ์ชัด" ครบ — ขาดอย่างใดอย่างหนึ่ง ห้ามแตะ 85`
