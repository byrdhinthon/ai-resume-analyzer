        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="bg-white rounded-lg shadow-sm border p-6 text-center">
              <p className="text-sm text-gray-500 mb-1">จำนวนครั้งที่วิเคราะห์</p>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6 text-center">
              <p className="text-sm text-gray-500 mb-1">คะแนนล่าสุด</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <Link href="/dashboard/analyze" className="block bg-white rounded-lg shadow-sm border p-6 hover:border-blue-300 transition">
              <h2 className="text-lg font-semibold mb-2 text-blue-600">วิเคราะห์เรซูเม่</h2>
              <p className="text-gray-500 text-sm">อัปโหลดเรซูเม่และเลือกตำแหน่งงานเพื่อรับคำแนะนำจาก AI</p>
            </Link>
            <Link href="/dashboard/history" className="block bg-white rounded-lg shadow-sm border p-6 hover:border-blue-300 transition">
              <h2 className="text-lg font-semibold mb-2 text-blue-600">ประวัติการวิเคราะห์</h2>
          ...
          {stats.latest && (
            <div className="bg-white rounded-lg shadow-sm border p-6">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-lg font-semibold">ผลวิเคราะห์ล่าสุด</h2>
              ...
              <div className="flex justify-between items-center">
                <div>
                  <p className="text-sm text-gray-600">ไฟล์: <strong>{stats.latest.file_name}</strong></p>
                  <p className="text-sm text-gray-600">ตำแหน่ง: <strong>{stats.latest.job_position}</strong></p>
