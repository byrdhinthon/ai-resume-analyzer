const translations = {
  th: {
    ...
    'admin.userDetail.deleteUser': 'ลบผู้ใช้',
    'admin.userDetail.deleteConfirm': 'ยืนยันลบผู้ใช้นี้?',
    'admin.userDetail.deleteWarning': 'การลบจะลบข้อมูลทั้งหมดออกจากระบบอย่างถาวร รวมถึงประวัติการวิเคราะห์และไฟล์ที่อัปโหลดทั้งหมด',
    'admin.userDetail.deleteSuccess': 'ลบผู้ใช้สำเร็จ',
    'admin.userDetail.deleteFailed': 'ลบผู้ใช้ล้มเหลว',
    'admin.userDetail.confirmDelete': 'ยืนยันลบ',
    'admin.userDetail.cancel': 'ยกเลิก',
    'admin.userDetail.cannotDeleteSelf': 'ไม่สามารถลบบัญชีของตัวเองได้',
  ...
  en: {
    ...
    'admin.userDetail.deleteConfirm': 'Delete this user?',
    'admin.userDetail.deleteWarning': 'This will permanently delete all data from the system, including all analysis history and uploaded files.',
    'admin.userDetail.deleteSuccess': 'User deleted successfully',
    'admin.userDetail.deleteFailed': 'Failed to delete user',
    'admin.userDetail.confirmDelete': 'Confirm Delete',
    'admin.userDetail.cancel': 'Cancel',
    'admin.userDetail.cannotDeleteSelf': 'Cannot delete your own account',
